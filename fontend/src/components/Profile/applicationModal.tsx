...
import { applicationSchema, ApplicationFormData } from './applicationValidationSchema';
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <ComboBox
            ...
            onSelect={(value) => setValue('jobType', value, { shouldValidate: true })}
          />
          ...
          <ComboBox
            ...
            onSelect={(value) => setValue('workLocation', value, { shouldValidate: true })}
          />
          ...
          <ComboBox
            ...
            placeholder="Status"
            onSelect={(value) => setValue('status', value, { shouldValidate: true })}
          />
          ...
          <input {...register('notes')} placeholder="Notes" className="input" />
